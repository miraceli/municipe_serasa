...
<html lang="pt-br">
	...
	<body>
		...
		$mes = date('m');
		$ano = date('Y');
		$nome = 'SJ - Serasa - Anotações - ';
		$extensao = '.xls';
		$arquivo = $nome . $mes . $ano .$extensao;
        //$arquivo = 'BC - Serasa - Anotações - 042021.xls';
        
        $html = '';
		$html .= '<p><strong>CONCESSÃO SÃO JOSÉ - MUNÍCIPES COM ANOTAÇÕES ATIVAS NA SERASA</strong></p>';
...
";
		...
		";
		$resultadoSqlTotal = mysqli_query($conexao4 , $sqlTotal);
