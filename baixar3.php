...
<html lang="pt-br">
	...
	<body>
		...
		$mes = date('m');
		$ano = date('Y');
		$nome = 'JVE - Serasa - Anotações - ';
		$extensao = '.xls';
		$arquivo = $nome . $mes . $ano .$extensao;
        //$arquivo = 'BC - Serasa - Anotações - 042021.xls';
        
        $html = '';
		$html .= '<p><strong>CONCESSÃO JOINVILLE - MUNÍCIPES COM ANOTAÇÕES ATIVAS NA SERASA</strong></p>';
...
";
		...
		";
		$resultadoSqlTotal = mysqli_query($conexao3 , $sqlTotal);
