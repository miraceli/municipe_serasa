...
<html lang="pt-br">
	...
	<body>
		...
		$mes = date('m');
		$ano = date('Y');
		$nome = 'ITA - Serasa - Anotações - ';
		$extensao = '.xls';
		$arquivo = $nome . $mes . $ano .$extensao;
        //$arquivo = 'BC - Serasa - Anotações - 042021.xls';
        
        $html = '';
		$html .= '<p><strong>CONCESSÃO ITAJAÍ - MUNÍCIPES COM ANOTAÇÕES ATIVAS NA SERASA</strong></p>';
...
";
		...
		";
		$resultadoSqlTotal = mysqli_query($conexao2 , $sqlTotal);
