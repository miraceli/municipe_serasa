...
<html lang="pt-br">
	...
	<body>
		...
		$mes = date('m');
		$ano = date('Y');
		$nome = 'BC - Serasa - Anotações - ';
		$extensao = '.xls';
		$arquivo = $nome . $mes . $ano . $extensao;

		$html = '';
		$html .= '<p><strong>CONCESSÃO BALNEÁRIO CAMBORIÚ - MUNÍCIPES COM ANOTAÇÕES ATIVAS NA SERASA</strong></p>';
...
";
		...
		";
		$resultadoSqlTotal = mysqli_query($conexao1, $sqlTotal);
